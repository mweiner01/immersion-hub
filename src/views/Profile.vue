<template>
        <div class="md:flex flex-col md:flex-row md:min-h-screen w-full">
            ...
            <div class="w-full bg-gray-200">
                <nav class="bg-white">
                    <div class="mx-auto flex items-center justify-between flex-wrap bg-white p-4">
                        <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl sm:py-4 sm:flex sm:items-center text-sm ml-auto mr-8">
                ...
                <div class="max-w-7xl mx-auto grid grid-cols-3 grid-flow-col gap-4">
